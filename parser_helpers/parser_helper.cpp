...
void test_verilog_parser (string filename) {
  ...
  do {
    ...
    if (valid) {
      //cout << cellInst << "," << cellType << endl ;
      for (int i=0; i < pinNetPairs.size(); ++i) {
        cout << cellInst << "/" << pinNetPairs[i].first << "," << cellType << endl ;
      }
    }
...
//	    return 1;
  //  }
    ///else
    //	cout << "Finished parsing lib succesfully." << endl ;
    ...
    if (!delayRetrieved) {
	    ...
	    cout << "Succesfully retrieved timing delay" << endl;

    cout << "Timing delay of arc " << fromPin << " -> " << toPin << " in the cell instance " << cellName << ": "
	    << timingDelay << endl;
    double outputSlew;
    ...
    if (!slewRetrieved) {
	    ...
	    return 1;
            ...
            cout << "Succesfully retrieved output slew" << endl;
    cout << "Output slew of arc " << fromPin << " -> " << toPin << " in the cell instance " << cellName << ": "
            << outputSlew << endl;
  }
